...
public class PerformanceConsultas {
    ...
    public static void main(String[] args) {
        ...
        PedidoDAO pedidoFetchDAO = new PedidoDAO(entityManager);

        Pedido pedidoConsulta = entityManager.find(Pedido.class, 1l);
        Pedido pedidoFetch = pedidoFetchDAO.buscarPedicoComCliente(1l);
        entityManager.close();

        System.out.println(pedidoFetch.getCliente().getNome());
    }
